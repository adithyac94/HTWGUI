...
public class ShootPrompt extends JFrame implements ActionListener {
   ...
   * @return Integer
   */
  public String getcaveNumbers() {
    return caveNumbers;
    //return Integer.parseInt(caveNumbers.isEmpty() ? "0" : caveNumbers);
  }
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    commands.add(getcaveDir());
    commands.add(getcaveNumbers());
    ic2.executeActionCommand("Shoot", commands);
